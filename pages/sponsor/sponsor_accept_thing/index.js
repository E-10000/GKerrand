...
Page({
  ...
  change(e){
      var sthing = e.currentTarget.dataset.sthing
      console.log(sthing)
      // object转化为json格式
      var jsonSthing = JSON.stringify(sthing);
      wx.navigateTo({
        url: '/pages/sponsor_thing/index?jsonSthing='+jsonSthing,
      })
  }
})